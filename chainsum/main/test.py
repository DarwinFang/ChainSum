...
def prepare_batch(batch, model):
    ...
    if args.cuda:
        ...
        if code_edge_rep is not None:
            code_edge_rep = code_edge_rep.cuda(non_blocking=True)
